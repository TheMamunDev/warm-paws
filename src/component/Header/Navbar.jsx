...
const Navbar = () => {
  ...
  const navLinksContent = (
    <>
      ...
      {isLoggedIn && <MyLink to={'/profile'}>My Profile</MyLink>}
    </>
  );

  return (
    <div className="navbar p-0 bg-[#FAF9F6] shadow-md sticky top-0 z-50 max-w-full">
      <div className="max-w-[1920px] mx-auto flex justify-between navbar p-0">
        <div className="navbar max-w-11/12 mx-auto p-0">
          <div className="navbar-start">
            ...
            <NavLink
              to="/"
              className="btn btn-ghost text-xl font-extrabold text-[#F4A261] px-0"
            >
              WarmPaws
            </NavLink>
          </div>
